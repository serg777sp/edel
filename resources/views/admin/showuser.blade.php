...
@section('left')
   ...
   <div class='order_box'>
        <div class="panel panel-warning">
            ...
            <div class="panel-body">
                @if($user->adresats->count() > 0)
                    <table class='table table-striped table-condensed'>
                    @foreach($user->adresats as $adresat)
                       <tr>
...
<!--модалки-->
    ...
    @include('modal.adm.addUserAdresat')
    @include('modal.adm.editUserProfile')
    @include('modal.adm.editUserPassword')
<!--конец модалок-->
@endsection
@section('right')
 @include('blocks.user_option')
@endsection