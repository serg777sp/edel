...
//        }
    ...
    protected function validateImageName($imageName){
//        dd(['image' => $imageName],[ 'image' => 'unique:prop_item,imgurl']);
        $validator = Validator::make(['image' => (string)$imageName], [ 'image' => 'unique:prop_item,imgurl']);
        if($validator->fails()){
